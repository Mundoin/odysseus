...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "browser_operator_safe_fill": "Fill safe non-sensitive text-like form fields on the current browser page. Two-phase: first call returns a redacted preview; re-call with confirmed=true to execute. Blocks password, file upload, payment, submit, apply. Use for 'fill the form', 'type in my details', 'autofill this page', 'populate the fields'. Do NOT call low-level browser_fill/browser_type MCP tools directly.",
